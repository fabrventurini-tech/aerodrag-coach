# AeroDrag — Prompt di comando: chat figlia «coach»
...
## Blocco specifico — coach

```
Dominio: logica coach. Gestisci i comandi coach (start/stop/lap) e il loro relay verso
app/device come da contratto (es. COACH_LINK).
TASK: <incarico coach>
```
